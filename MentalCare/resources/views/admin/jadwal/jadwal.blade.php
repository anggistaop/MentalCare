    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-color" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="#" class="list-group-item list-group-item-action bg-transparent second-text fw-bold text-white"><i
                        class="fas fa-user me-2"></i>User</a>
                <a href="psikolog.html" class="list-group-item list-group-item-action bg-transparent second-text fw-bold text-white"><i
                        class="fas fa-users me-2"></i>Psikolog</a>
                <a href="jadwal.html" class="list-group-item list-group-item-action bg-transparent second-text fw-bold text-white"><i
                        class="fas fa-calendar-times me-2"></i>Jadwal</a>
        ...
        <div class="primary-bg" id="page-content-wrapper">
            ...
            <div class="row d-flex justify-content-between">
              ...
              <div class="col-md-4 text-end">
                <button class="btn btn-primary fs-7 mb-3">Tambah Data</button>
              </div>
            </div>
            <div class="col">
              <table class="table bg-white rounded shadow-sm table-hover">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <a href="detail-jadwal.html" class="btn btn-primary"
                        >Detail</a
                      >
                    </td>
                  </tr>
