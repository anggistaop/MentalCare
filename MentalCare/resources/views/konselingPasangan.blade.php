...
<head>
    ...
    <title>Layanan Konseling Pasangan</title>
</head>
<body>
    <header>
        <nav>
            ...
            <div class="layanan-item">
                <div class="item-1">
                    ...
                    <button class="selengkapnya">
                        <a href="./layanan/pasanganOnline/pasanganOnline.html">Konsultasi Sekarang</a>
                    </button>
                </div>
                <div class="item-2">
                    ...
                    <button class="selengkapnya-1">
                        <a href="./layanan/pasanganOffline/pasanganOffline.html">Konsultasi Sekarang</a>
                    </button>
                </div>
            </div>
        </div>               
